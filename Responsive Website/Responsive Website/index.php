...
<head>
  ...
  <script src="//code.tidio.co/hcdabffu9ayrmv90hisskhel9rsgmfyt.js" async></script>
</head>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="price-wrapper">
                  ...
                  <data class="price">₹249.00</data>

                  <del class="del" value="69.00">₹319.00</del>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="price-wrapper">
                  ...
                  <data class="price" value="29.00">₹229.00</data>

                  <del class="del">₹399.00</del>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="price-wrapper">
                  ...
                  <data class="price" value="49.00">₹259.00</data>

                  <del class="del">₹450.00</del>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="price-wrapper">
                  ...
                  <data class="price" value="59.00 ">₹249.00</data>

                  <del class="del">₹329.00</del>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="price-wrapper">
                  ...
                  <data class="price" value="49.00">₹129.00</data>

                  <del class="del">₹229.00</del>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="price-wrapper">
                  ...
                  <data class="price" value="49.00">₹419.00</data>

                  <del class="del">₹619.00</del>
    ...
    <div class="footer-top" style="background-image: url('./assets/images/footer-illustration.png')">
      <div class="container">
        ...
        <ul class="footer-list">
          ...
          <li>
            <p class="footer-list-item">+91 9019604158</p>
          </li>

          <li>
            <p class="footer-list-item">diyona@gmail.com</p>
          </li>

          <li>
            <address class="footer-list-item">Bagular Cross,Near Almart ,Yelahanka ,Bangalore 560064</address>
          </li>
        ...
        <form action="" class="footer-form" method="post">
          ...
          <button type="submit" class="btn" value="send message" name="send" >Book a Table</button>
    ...
    <div class="footer-bottom">
      <div class="container">
        <p class="copyright-text">
          &copy; 2022 <a href="#" class="copyright-link">diyonaborges</a> All Rights Reserved.
        </p>
      </div>
    </div>
